...
This folder contains seven TEI P5 documents with full text and document metadata, plus the 40 PNG scans they reference.
...
Run `uv run validate_tei.py tei` from this folder. The checker uses the local TEI Lite schema. Open at least one scan and compare it with the corresponding text.
